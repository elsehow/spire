...
},{"./src/dateSelector.js":2,"./src/myCoolGraph.js":3,"./src/spireAPI.js":4,"./src/windowed.js":5,"jquery":6,"kefir":7,"lodash":8}],2:[function(require,module,exports){
var $ = require('jquery')
...
},{"jquery":6,"kefir":7}],3:[function(require,module,exports){
var $                 = require('jquery')
...
},{"./spireAPI.js":4,"jquery":6,"lodash":8}],4:[function(require,module,exports){
var $ = require('jquery')
var Kefir = require('kefir')
...
var queryOpts = function (type, date) {
   var url = 'http://localhost:3000/breath'
   return { url: url  }
}
...
var averageReading = function (coll) {
 return {
   timestamp:  mean(coll, 'value'),
   value:      mean(coll, 'timestamp'),
 }
}
